...
namespace API.Controllers
{
    public class TreatmentsController : ApiController
    {
        ...
        public async Task<IHttpActionResult> PostTreatment(Treatment treatment)
        {
            ...
            {
                if (TreatmentExists(treatment.ProcId))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtRoute("DefaultApi", new { id = treatment.ProcId }, treatment);
        }
        ...
        {
            return db.Treatments.Count(e => e.ProcId == id) > 0;
        }
    }
}