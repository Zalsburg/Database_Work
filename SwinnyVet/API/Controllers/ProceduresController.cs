...
namespace API.Controllers
{
    public class ProceduresController : ApiController
    {
        ...
        public async Task<IHttpActionResult> PostProcedure(Procedure procedure)
        {
            ...
            {
                if (ProcedureExists(procedure.ProcId))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtRoute("DefaultApi", new { id = procedure.ProcId }, procedure);
        }
        ...
        {
            return db.Procedures.Count(e => e.ProcId == id) > 0;
        }
    }
}